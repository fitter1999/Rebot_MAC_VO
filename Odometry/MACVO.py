...
class MACVO(IOdometry[T_SensorFrame], ConfigTestable):
    ...
    def __init__(
        ...
        **_excessive_args,
        ...
        mapping_num_point = _excessive_args.pop("mapping_num_point", 2000)
        ...
        self.mapping_num_point: int = int(mapping_num_point)
    ...
    def run_pair(self, frame0: T_SensorFrame, frame1: T_SensorFrame) -> None:
        ...
        if self.mapping:
            map0_uv       = self.MappointSelector.select_point(frame0.stereo, self.mapping_num_point, depth0, depth1, match01)
